            ...
            <form class="general-form">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 ">
                    <div class="form-group">
                      ...
                      <v-select placeholder="Select an airport" :options="airportoptions" label="name"
                                :class="{'azul':!color}" v-model="airport_name" :value="airport_name"
                                id="inputGroupSelect01" v-on:change="fligh_name"></v-select>
                    </div>
                  </div>
                  <div class="col-lg-2">
                    <div class="form-group">
                                    ...
                                    <form class="general-form">
                                      <fieldset>
                                        ...
                                        <div class="row">
                                          <div class="col-lg-12 ">
                                            <div class="custom-radio-btn mt-0 form-group">
                                              ...
                                              <div
                                                ...
                                                <div class="form-check px-0 ms-0 me-4">
                                                  <label class="radio-container text-capitalize">Arrival
                                                    <input type="radio" v-model="is_arrival_flight" v-bind:value="true"
                                                           name="radio">
                                                    <span class="checkmark"></span>
                                                  </label>
                                                </div>
                                                <div class="form-check ms-0">
                                                  <label class="radio-container text-capitalize">Departure
                                                    <input type="radio" v-model="is_arrival_flight" v-bind:value="false"
                                                           name="radio">
                                                    <span class="checkmark"></span>
                                                  </label>
                                                </div>
                                          ...
                                          <div class="col-lg-3 ">
                                            <div class="form-group">
                                              <label class="form-label" for="inputGroupSelect01">{{is_arrival_flight ==
                                                true ? 'Arriving from' :'Departing from'}}<span class="asterik">*</span></label>
                                              <select class="form-select" v-model="airport_id" id="inputGroupSelect01"
                                                      @change="fligh_name($event)">
                                                <option v-for="item in airportoptions" :key="item.id" :value="item.id">
                                                  {{item.name}}
                                                </option>
                                              </select>
                                            </div>
                                          ...
                                          <div class="col-lg-2">
                                            <div class="form-group">
                                              <label class="form-label text-capitalize">date<span
                                                  class="asterik">*</span></label>
                                              <div class="form-border">
                                                <input type="date" onkeydown="return false" v-model="date"
                                                       class="form-control border-0" placeholder="DD/MM/YYYY">
                                                <div class="d-flex align-items-center">
                                          ...
                                          <div class="col-lg-2 ">
                                            <div class="form-group">
                                              ...
                                              <div class="form-border"><input onkeydown="return false" type="time"
                                                                              class="form-control border-0"
                                                                              v-model="time" placeholder="HH:MM">
                                                <span class="input-icon"><img
                                                    src="../../assets/images/icons/schedule.svg" alt="couch"
                                      ...
                                      <fieldset>
                                        ...
                                        <div class="row align-items-baseline">
                                          <div class="col-lg-2 ">
                                            <div class="form-group">
                                              <label class="form-label text-capitalize">Adults <span
                                                  class="asterik">*</span></label>
                                          ...
                                          <div class="col-lg-2">
                                            <div class="form-group">
                                              <label class="form-label text-capitalize">Children <span
                                                  class="fw-normal text-lowercase">(2 to 12 years)</span> </label>
                                              <div class="input-group">
                                          ...
                                          <div class="col-lg-2">
                                            <div class="form-group">
                                              <label class="form-label text-capitalize">Infants <span
                                                  class="fw-normal text-lowercase">(below 2 years)</span></label>
                                              <div class="input-group">
                                                <a @click="number_of_infantsDec">
                                                  <span class="fa fa-minus minus-icon"></span>
                                                </a>
                                                <input type="text" class="form-control" placeholder="e.g. 0"
                                                       v-model="number_of_infants"/>
                            ...
                            <div class="col-lg-2 ">
                              <div class="form-group">
                                ...
                                <div class="form-border">
                                  ...
                                  <vue-timepicker v-model="time" class="form-control border-0" format="HH:mm"
                                                  @change="changeTime"></vue-timepicker>
              ...
              <fieldset>
                ...
                <div class="row align-items-baseline">
                  ...
                  <div class="col-lg-2">
                    <div class="form-group">
                      <label class="form-label text-capitalize">Children <span class="fw-normal text-lowercase">(2 to 12 years)</span>
                      </label>
                      <div class="input-group">
                        <a @click="number_of_childrenDec()">
                          <span class="fa fa-minus minus-icon"></span></a>
    ...
    <div class="elite-forrm-footer">
      <div class="container">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="d-block">
                      <span class="btn-next d-inline-block align-top transition"
                            v-if="!(airport_id && date && time && flight_number && number_of_adults )"
                            :disabled="notFormValid" @click="error()">
                            Next
                        </span>
