                            ...
                            <div class="accordion detail-section" id="accordionExample">
                                                ...
                                                <div class="d-flex flex-column flex-md-row">
                                                    ...
                                                    <div v-else  class="elite-offer-service">
                                                        <label class="custom-radio">
                                                            <div class="checkmark">
                                                                <strong
                                                                    class="service-name d-block mb-lg-3 mb-2">Private
                                                                    Lounge</strong>
                                                                <strong class="service-price d-block mb-3">BHD
                                                                ...
                                                                <ul class="ul_css">
                                                                    <li>
                                                                        <div class="d-flex align-items-baseline">
                                                                            <p
                                                                                class="extra-small-text w-p text-capitalize">
                                                                                Flight Status<span
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <div class="accordian-ul">
                                                <ul class="ul_css" v-for="(passenger, index) in passengers" :key="passenger">
                                                    <li>
                                                        <div class="d-flex mobile-col">
        ...
        <div class="elite-forrm-footer">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-block">
                        <router-link to="/elite-form4" class="cancel-link d-inline-block text-decoration-none">Back
                        </router-link>
                    </div>
