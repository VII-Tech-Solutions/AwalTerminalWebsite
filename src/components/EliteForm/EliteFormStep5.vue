            ...
            <div class="form-body">
                <div class="form-page-title">
                    <div class="d-flex flex-md-row flex-column align-items-center justify-content-between">
                        ...
                        <p class="form-p lora-semi m-0">Step <span>5</span> of <span>5</span></p>
                    </div>
                </div>
                <div class="row">
...
<style>
/*  */
.form-p.text-green{color:#00ab8d;} .sans{font-family: 'Source Sans Pro';}
...
.elite-offer-services .service-features{font-size:14px;line-height:21px;color:#011e41;}
...
.details-list ul li > div {flex-direction:column;}
} */
</style>
