          ...
          <div class="col-lg-8 col-md-10">
            <form @submit.prevent="paynow" class="general-form form-details">
              <fieldset class="mb-3">
                ...
                <p class="fw-semi-bold form-p mb-lg-3 mb-2">
                  Here is an overview of all the details you have submitted
                </p>
              </fieldset>
              <div
                class="accordion detail-section pb-lg-4 pb-3"
                id="accordionExample"
              >
                    ...
                    <div class="accordion-body elite-form">
                      <div class="elite-offer-services d-flex flex-column">
                        <div class="d-flex flex-column flex-md-row">
                          <div
                            v-if="elite_services.service_id == 1"
                              ...
                              <div class="checkmark">
                                ...
                                <ul class="list-unstyled service-features">
                                  <li class="position-relative">
                                    50% of the adult rate for children aged 2 to
                                    12
                                  </li>
                                  <li class="position-relative">
                                    Free entry for infants ( 0 to 2 years old)
                                  </li>
                                  <li class="position-relative">
                                    10% group discount (5 PAX and above)
                                  </li>
                                </ul>
                                <span class="tax-text"
                          ...
                          <div
                            v-if="elite_services.service_id == 2"
                            class="elite-offer-service"
                          >
                            <label class="custom-radio">
                              <div class="checkmark">
                                <strong
                                ...
                                <ul class="list-unstyled service-features">
                                  <li class="position-relative">
                                    Minimum of 2 adults full fares required to
                                    access a Private Lounge
                                  </li>
                                  <li class="position-relative">
                                    50% of the adult rate for children aged 2 to
                                    12
                                  ...
                                  <li class="position-relative">
                                    Rates are per passenger capped at a total
                                    BHD 600.000 per lounge
                                  </li>
                                  <li class="position-relative">
                                    Rates apply to standard lounge size with a
                                    maximum of 6 passengers per lounge
                                  </li>
                                </ul>
                                <span class="tax-text"
                                  >* 10% VAT on the total amount</span
                                ...
                                <ul class="ul_css">
                                  <li>
                                    <div class="d-flex align-items-baseline">
                                      ...
                                      >
                                        {{
                                          elite_services.is_arrival_flight == 0
                                            ? "Arrival"
                                            : "Depature"
                                        }}
                                      </p>
                                  ...
                                  <li>
                                    <div class="d-flex align-items-baseline" v-if="
                                        airportoptions &&
                                      ...
                                      >
                                        ...
                                        <span v-if="arrive_from.id == elite_services.airport_id ">
                                          {{ arrive_from.name }}
                                        </span>
                                  ...
                                  <li>
                                    <div class="d-flex align-items-baseline">
                                      ...
                                      <p
                                        ...
                                        "
                                      >
                                        {{ elite_services.number_of_adults }}
                                      </p>
                                    </div>
                                  </li>
                                  <li>
                                    <div class="d-flex align-items-baseline">
                                      ...
                                      <p
                                        ...
                                        "
                                      >
                                        {{ elite_services.number_of_children }}
                                      </p>
                                    </div>
                                  </li>
                                  <li>
                                    <div class="d-flex align-items-baseline">
                                      ...
                                      <p
                                        ...
                                        "
                                      >
                                        {{ elite_services.number_of_infants }}
                                      </p>
                                    </div>
                                  </li>
                                </ul>
                                  ...
                                  <li>
                                    ...
                                    >
                                      ...
                                      <p
                                        ...
                                        :key="index"
                                      >
                                        <span v-if="nation_name.id == passenger.nationality_id ">
                                          {{ nation_name.name }}
                                        </span>
                                      </p>
                                    </div>
                      ...
                      <div class="details-list">
                        <ul class="ul_css">
                          ...
                          <li>
                            <div class="d-flex align-items-baseline">
                              <p class="extra-small-text w-p text-capitalize">
                                email address<span class="asterik">*</span>
                              </p>
                      ...
                      <div class="col-md-5 mb-md-0 mb-2">
                        <div class="credit-box">
                          ...
                          <figure class="mb-0">
                            <img
                              class="img-fluid"
                              src="../../assets/images/icons/debit-card.svg"
                            />
                          </figure>
                        </div>
                      </div>
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="d-flex align-items-center">
            <p class="fw-semi-bold form-p mb-0 me-lg-3 me-2 sans">
              Total Amount:<span>BHD {{ elite_services.total }}</span>
            </p>
            <div class="d-block">
              <a
                :href="paymentlink"
...
export default {
  ...
  methods: {
    getMetaData() {
      ...
      axios
        .get("https://admin.awalvip.bh//api/metadata", axiosConfig)
        .then((res) => {
    ...
    isCredit() {
      //debugger;
      this.paymentlink =
        this.paymentlink.split("?payment_method")[0] +
        "?payment_method=" +
        this.is_credit;
    },
  },
