...
<style>
	.elite-form {padding: 60px 0 100px;}
	...
	@media only screen and (max-width:767px){
		...
		.elite-form .logo-holder{margin:0 0 30px;}
		.elite-form .step-heading{font-size:30px;line-height:34px;}
		.elite-form h3{font-size:18px;line-height:22px;}
		.elite-offer-services .elite-offer-service{width:100%;margin:0 0 20px;}
		.elite-offer-services .service-name{font-size:24px;line-height:27px;}
		.elite-forrm-footer{padding:15px 0;}
	}
	@media only screen and (max-width:575px){
		.elite-form .elit-form-logo{width:60px;}
		.elite-form .logo-holder{margin:0 0 20px;}
		.elite-form .step-text-block p{font-size:16px;line-height:22px;}
		.elite-form .custom-radio .checkmark{padding:15px;}
	}
	@media only screen and (max-width:479px){
		.elite-form .step-heading{font-size:26px;line-height:30px;}
	}
	</style>