              ...
              <fieldset class="mb-0">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 mb-0">
                    ...
                    <div class="form-group">
                      <label for="exampleFormControlTextarea1" class="form-label text-capitalize">billing address<span
                          class="asterik">*</span></label>
                      <textarea class="form-control" v-model="operator_billing_address"
                                placeholder="Enter the billing address" id="exampleFormControlTextarea1"
                                rows="3"></textarea>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-6 mb-0">
                    ...
                    <div class="form-group">
                      <label for="exampleFormControlTextarea1" class="form-label text-capitalize">address<span
                          class="asterik">*</span></label>
                      <textarea class="form-control" v-model="agent_address" placeholder="Enter your address"
                                id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                  </div>
                  <div class="col-lg-6 mb-0">
                    ...
                    <div class="form-group">
                      <label for="exampleFormControlTextarea1" class="form-label text-capitalize">billing address<span
                          class="asterik">*</span></label>
                      <textarea class="form-control" v-model="agent_billing_address"
                                placeholder="Enter the billing address" id="exampleFormControlTextarea1"
                                rows="3"></textarea>
                    </div>
                  </div>
