<template>
    <div class="thank-you-page background-gradient">
        <div class="container">
...
.background-gradient{
    ...
    url('../../assets/images/thankyou-bg.webp');
    width: 100%;
    height: 100vh;
    background-size: cover;
}
.contact-links{color:#011e41;}
.contact-links:hover{color:#011e41;}
.thankyou-p{width:100%;max-width: 700px; margin-bottom:77px;margin-top: 60px;}
.thankyou-p h2 {
    font-size: 50px;
    line-height: 65px;
    margin-bottom: 30px;
...
.thankyou-p {width:100%; margin-bottom:60px;
}
.thankyou-p {
    margin-bottom: 30px;
    margin-top: 30px;
