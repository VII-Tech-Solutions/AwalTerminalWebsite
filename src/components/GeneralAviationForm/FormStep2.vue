                ...
                <div class="row">
                  <div class="col-lg-6 mb-0">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" v-model="arrival_flight_nature" class="form-control"
                             placeholder="Nature of Flight">
                    </div>
                  </div>
                  <div class="col-lg-6 mb-0">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-border">
                        <input type="date" onkeydown="return false" v-model="arrival_date" class="form-control border-0"
              ...
              <fieldset>
                ...
                <div class="row">
                  <div class="col-lg-6 mb-0">
                    ...
                    <div class="form-group">
                      <label class="form-label">Nature of Flight<span class="asterik">*</span></label>
                      <input type="text" v-model="departure_flight_nature" class="form-control"
                             placeholder="Nature of Flight">
                    </div>
                  </div>
                  <div class="col-lg-6 mb-0">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-border">
                        <input type="date" v-model="departure_date" class="form-control border-0"
                               placeholder="DD/MM/YYYY">
