                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-0">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" v-model="arrival_passenger_count" class="form-control" placeholder="Passenger Count">
                                        </div> 
                                    </div> 
                                </div>
                            </fieldset>
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-0">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label text-capitalize">Passenger Count<span class="asterik">*</span></label>
                                            <input type="text" v-model="departure_passenger_count" class="form-control" placeholder="Passenger Count">
                                        </div> 
                                    </div> 
                                </div>
                            </fieldset>
