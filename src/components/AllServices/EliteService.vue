                ...
                <div class="bg-white service-fixed">
                    <div class="main-page-title">
                        <div class="page-title">
                            <h2 class=" mx-auto text-center" data-aos="fade-up" data-aos-duration="2500">{{ heading3 }}
                            </h2>
                            <p class="mx-auto w-100 mb-lg-4 mb-3" data-aos="fade-up" data-aos-duration="2500">{{paragraph2}}</p>
                            <div class="d-flex justify-content-center">
                                <router-link to="/elite-form" data-aos="fade-bottom" data-aos-duration="2500"
                                    class="blue-btn text-uppercase d-inline">book now</router-link>
                            </div>
                        </div>
                    </div>
                    <div class="service-card">
                        <div class="row">
                            <div class="col-lg-6 mb-lg-0 mb-2">
                                <div class="service-card-style book-service-card" data-aos="fade-up"
                                    data-aos-duration="2500">
                                    <div class="d-flex flex-column justify-content-between h-100">
                                        <div class="service-card-body">
                                            <div class="title-content">
                                                <strong
                                                    class="service-title text-capitalize theme mb-lg-3 mb-2 d-block">Common
                                                    Lounge</strong>
                                                <p class="service-cost text-uppercase">bhd {{ eliteserviceoptions !=
                                                        undefined ? eliteserviceoptions[0].price_per_adult : ''
                                                }} <span
                                                        class="text-lowercase gold-text">/adult</span></p>
                                            </div>
                                            <div class="service-checklist">
                                                <ul class="ul_css">
                                                    <li class="position-relative" v-for="item in commontype"
                                                        :key="item.id">
                                                        <div class="checklist-points"><span class="icon"><i
                                ...
                                <div class="service-card-style book-service-card" data-aos="fade-up"
                                    ...
                                    <div class="d-flex flex-column justify-content-between h-100">
                                        <div class="service-card-body">
                                            <div class="title-content">
                                                <strong
                                                    class="service-title text-capitalize theme mb-lg-3 mb-2 d-block">Private
                                                    Lounge</strong>
                                                <p class="service-cost text-uppercase">bhd {{ eliteserviceoptions !=
                                                        undefined ? eliteserviceoptions[1].price_per_adult : ''
                                                }} <span
                                                        class="text-lowercase gold-text">/adult</span></p>
                                            </div>
                                            <div class="service-checklist">
                                                <ul class="ul_css">
                                                    <li class="position-relative" v-for="item in privatetype"
                                                        :key="item.id">
                                                        <div class="checklist-points"><span class="icon"><i
                                                                    class="fa fa-check" aria-hidden="true"></i></span>
                                                            <p>{{ item.feature_details }}</p>
...
<style>
.service-card-style.book-service-card {
    padding: 40px 30px;
}

.service-card-body .service-cost {
    font-size: 26px;
    font-weight: 800;
    line-height: 30px;
    color: #caa17b;
...
.service-checklist ul li:not(:last-child) {
    margin-bottom: 20px;
}

.service-checklist ul li .checklist-points {
    display: flex;
    align-items: center;
}

.service-checklist ul li .checklist-points .icon {
    margin-right: 10px;
    width: 20px;
}

.service-checklist ul li .checklist-points p {
    font-size: 18px;
    line-height: 22px;
    color: #011e41;
}
